  ...
  return (
    <article className="card bg-info text-info-content w-full shadow-xl relative overflow-hidden">
      ...
      <div className="card-body relative p-10 flex-row gap-10 flex-wrap">
        ...
        <span className="h-16 w-16 rounded-lg border-4 border-info/60 flex items-center justify-center bg-white order-1">
        ...
        <div className="card-actions ms-auto order-2 md:order-2">
